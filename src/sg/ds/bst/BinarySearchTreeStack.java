 ...
 * @author sachin
 */
public class BinarySearchTreeStack {
    ...
    public boolean sameTree(BinarySearchTreeStack bst) { //is this tree same as another given tree?
...
//        return getLeftNodeCount(root);
//    }
//
//    public int getRightNodeCount() {
//        return getRightNodeCount(root);
//    }

//    private int getLeftNodeCount(Node node) {
//        Node n = node;
//        int count = 0;
//        while (n != null) {
//            n = n.left;
...
//    }
//
//    private int getRightNodeCount(Node node) {
//        Node n = node;
//        int count = 0;
//        while (n != null) {
//            n = n.right;
...
//    }
    ...
    public void getInorderStk() {
    	Node node = root;
    	//List inOrdArr = new ArrayList();
    	printTree();
    	Stack<Node> stk = new Stack<Node>();
    	Map<Node, Integer> statusMap = new HashMap<Node, Integer>();
    	...
    	if (node.left!=null) {
    	stk.push(node.left);
    	System.out.println("push: "+node.left);
    	continue;
    	}
    	//inOrdArr.add(node.data);
    	System.out.println(((Node)stk.pop()).data);
    	System.out.println("pop: "+node);
    	
    	
    	if (node.right!=null) {
    	stk.push(node.right);
    	System.out.println("push: "+node.right);
    	continue;
    	}
    	} //end of while
    ...
    public static void main(String[] args) {
        BinarySearchTreeStack bst = new BinarySearchTreeStack();
        int treesize = 5;
        bst.buildTree(treesize);
        //treesize = bst.buildTreeFromOutputString("4 4 4 6 7");
        treesize = bst.buildTreeFromOutputString("3 2 1 4 5");
        bst.getInorderStk();
...
//        BinarySearchTreeStack bst2 = new BinarySearchTreeStack();
//        bst2.buildTree(treesize);
//        treesize = bst2.buildTreeFromOutputString("3 4 6 3 6");
//        bst2.printTree();
//        System.out.println("Same tree:" + bst.sameTree(bst2));
//        int numKeys = 4;
//        System.out.println("Number of binary Trees for '" + numKeys + "' keys=" + BinarySearchTreeStack.countTrees(4));
