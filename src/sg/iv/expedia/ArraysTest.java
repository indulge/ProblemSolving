...
// int[] arr = test.buildArrayFromString("5, 2, 4, 1, 3", ", ");
...
// ) {
//
// System.out.println("curr Index: "+ (i) +" prev Val: "+prevVal +
// " current val: "+arr[i + dupCount] + " duplicates: "+dupCount);
// if (arr[i + dupCount] != i + 1 - dupCount) {
//
// int num1 = arr[arr[i + dupCount] - 1];
// int num2 = arr[i + dupCount];
...
// }
//
// ArrayUtil.printArray("inter", arr);
// }
// //ArrayUtil.printArray("Sorted Array with no missing values: ", arr);
// }
